...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"UserService\": () => (/* binding */ UserService)\n/* harmony export */ });\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ \"./src/modules/helpers.js\");\n\n\n\nclass UserService {\n    constructor (url) {\n        this.url = url\n    }\n\n   getUsers() {\n       return (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getData)(this.url);\n   }\n\n   addUsers(user) {\n       return (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.method)(this.url, '', 'POST', user)\n   }\n\n   removeUsers(id) {\n       return fetch(`${this.url}/${id}`, {\n            method: 'DELETE'\n                }).then(res => res.json())\n   }\n\n   changeUser(id, data) {\n       return (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.method)(this.url, `/${id}`, 'PATCH', data)\n   }\n\n   getUser(id) {\n        return (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getData)(this.url, `/${id}`);\n   }\n\n   editUser(id, user) {\n       return (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.method)(this.url, `/${id}`, 'PUT', user)\n   }\n\n   filterUsers(filterOption) {\n       return (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getData)(this.url,`/?${filterOption}=true`);\n   }\n\n   getSortUsers(sortOption) {\n       return (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getData)(this.url, `/?_sort=${sortOption.name}&_order=${sortOption.value}`);\n   }\n\n   getSearchUsers(str) {\n        return (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.getData)(this.url, `/?name_like=${str}`);\n   }\n}\n\n//# sourceURL=webpack://json-sever__lesson/./src/modules/userService.js?");
